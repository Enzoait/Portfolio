        ...
        <div className="absolute inset-0 overflow-hidden">
          <div
            ...
            style={
              {
                background:
                  "radial-gradient(circle at 20% 15%, color-mix(in srgb, var(--light-rays-color) 80%, transparent), transparent 90%)",
              } as CSSProperties
            }
          />
          <div
            ...
            style={
              {
                background:
                  "radial-gradient(circle at 80% 10%, color-mix(in srgb, var(--light-rays-color) 80%, transparent), transparent 90%)",
              } as CSSProperties
            }
          />
          {rays.map((ray) => (
